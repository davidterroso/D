...
class UpSample(Module):
    ...
    def forward(self, x1: Tensor, x2: Tensor):
        ...
        Args: 
            self (UpSample object): the 
                UpSample object which is going
                to be performed on input x
...
class UNet(Module):
    ...
    def __init__(self, in_channels: int, num_classes: int):
        ...
        self.down_convolution_1 = DownSample(in_channels, 64) # (h, w, 1) -> (h / 2, w / 2, 64)
        self.down_convolution_2 = DownSample(64, 128) # (h / 2, w / 2, 64) -> ((h / 2) / 2, (w / 2) / 2, 128)
        self.down_convolution_3 = DownSample(128, 256) # ((h / 2) / 2, (w / 2) / 2, 128) -> (((h / 2) / 2) / 2, ((w / 2) / 2) / 2, 256)
        self.down_convolution_4 = DownSample(256, 512) # (((h / 2) / 2) / 2, ((w / 2) / 2) / 2, 256) -> ((((h / 2) / 2) / 2) / 2, (((w / 2) / 2) / 2) / 2, 512)

        # Double convolution on the bottleneck
        self.bottle_neck = DoubleConvolution(512, 1024) # ((((h / 2) / 2) / 2) / 2, ((((w / 2) / 2) / 2) /  2, 512) -> (((((h / 2) / 2) / 2) / 2) / 2, ((((w / 2) / 2) / 2) / 2) / 2, 1024)

        # Up-convolutions that form the decoding path
        self.up_convolution_1 = UpSample(1024, 512) # (((((h / 2) / 2) / 2) / 2) / 2, ((((w / 2) / 2) / 2) / 2) / 2, 1024) -> ((((h / 2) / 2) / 2) / 2, (((w / 2) / 2) / 2) /  2, 512)
        self.up_convolution_2 = UpSample(512, 256) # ((((h / 2) / 2) / 2) / 2, (((w / 2) / 2) / 2) /  2, 512) -> (((h / 2) / 2) / 2, ((w / 2) / 2) / 2, 256)
        self.up_convolution_3 = UpSample(256, 128) # (((h / 2) / 2) / 2, ((w / 2) / 2) / 2, 256) -> ((h / 2) / 2, (w / 2) / 2, 128)
        self.up_convolution_4 = UpSample(128, 64) # ((h / 2) / 2, (w / 2) / 2, 128) -> (h / 2, w / 2, 64)
