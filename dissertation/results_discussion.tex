...
\par
In the following subsection, the results shown in Table \ref{tab:FluidVolumesExperiment1} will be compared with the estimated fluid volumes obtained using only generated slices and in an enhanced volume, where between every known slice another slice is generated.
