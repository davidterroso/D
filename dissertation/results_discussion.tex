...
One of the trends that becomes evident when looking at this table is the difference in results between devices, which is constant independently of the fold in which it was trained.
\par
