...
\par
The balanced cross-entropy loss was tested on the best and worse performing folds of the IRF split, for the segmentation of IRF, in the same conditions. However, since the results were much worse than those obtained with the initial loss, no more folds or fluids were tested.
\par
