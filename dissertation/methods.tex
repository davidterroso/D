...
\par
The final activation function, the hyperbolic tangent, outputs values between -1 and 1. Two activation functions were compared: hyperbolic tangent and sigmoid. The hyperbolic tangent worked best since it used the whole data range in the output, while sigmoid concentrated the outputs in a narrower range. After applying the hyperbolic tangent, the results had to be converted to range 0 to 1, where it can be compared to the GT images.
\par
