...
\par
The best performing segmentation models were also evaluated on a private dataset provided by Centro Hospitalar Universitário de São João (CHUSJ). This dataset comprises six Spectralis OCT volumes, containing 19 slices. The volumes vary in resolution, dimensions, noise levels, and contrasts, offering diverse testing scenarios. All volumes include at least one type of fluid, though the overall fluid presence is limited.
\par
...
\begin{figure}[!ht]
	...
	\caption{Visually similar PED regions are segmented in one dataset but not on the other. This ambiguous segmentation can translate to worse performances in the model.}
